...
function ComputePoint(x, y, anchor, rotation) {
  let coord = {x:0, y:0};
...
export default function UpdateBounds(bounds, frame, transform) {
  ...
  coords[0] = ComputePoint( pos.x, pos.y, anchor, rotation);
  coords[1] = ComputePoint( pos.x + size.x,  pos.y, anchor,rotation);
  coords[2] = ComputePoint( pos.x , pos.y + size.y, anchor,rotation);
  coords[3] = ComputePoint( pos.x + size.x , pos.y + size.y,anchor, rotation);
